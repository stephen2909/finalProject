...
<body>
	...
	<div class="w3-main">
		...
		<div class="w3-threequarter" style="float: right;margin-top: 12%; margin-left: 2%;" >
			...
			?>
			<h2 class="w3-grey w3-card w3-text-black"> Adding a New <?php echo $temp; ?></h2>
			...
			<fieldset>
				...
				<div class="w3-container " id="formG">
					Name: <input type="text" style="margin-bottom: 10px"><br>
					Description: <textarea style="width: 85%;"></textarea>
				</div>
			</fieldset>
			<?php
			if ($temp=="Assignment") {
			...
			<fieldset style="margin-top: 20px">
				...
				<div class="w3-container " id="formF">
					<p style="font-weight: bold">Select File <i class="fa fa-question-circle"></i></p>
				</div>
			</fieldset>
